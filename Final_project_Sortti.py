...
df_elecprice = pd.read_csv('https://github.com/GeekyFin/dam/raw/refs/heads/main/sahkon-hinta-010121-240924.csv', delimiter=',') #note, electricity price data starts from 1.1.2021
